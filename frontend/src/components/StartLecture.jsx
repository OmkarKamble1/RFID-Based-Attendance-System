...
export default function StartLecture() {
  return (
    <>
        <Header />
        <div className='relative min-h-[70vh] w-screen bg-violet-100 '>
            <div className='p-10'>
            ...
            <div className='min-h-[55vh]  flex flex-col  '>
                <div className='border-b-2 border-slate-300' >
                    <div className='  py-6 flex justify-center '>
                            ...
                            <select name="branch" id="branch" className='mx-5 bg-violet-200 focus:outline-1 focus:outline-slate-100 w-[12vw]'>
                    ...
                    <div className=' py-6  flex justify-center'>
                            ...
                            <select name="branch" id="semester" className='mx-5 bg-violet-200 focus:outline-1 focus:outline-slate-100 w-[12vw]'>
                    ...
                    <div className=' py-6 flex justify-center'>
                            ...
                            <select name="branch" id="division" className='mx-5 bg-violet-200 focus:outline-1 focus:outline-slate-100 w-[12vw]'>
                    ...
                    <div className='py-6  flex flex-col justify-center'>
                        ...
                        <input type='time' value='time'className=' mx-5 bg-violet-200 focus:outline-1 focus:outline-slate-100 w-[12vw]'></input>
                    

                </div>
                <div className='w-[100vw] py-5 border-l-2 border-slate-400 flex flex-wrap justify-center content-center'>
                    <Link to={"/lecture"} className='bg-violet-500
